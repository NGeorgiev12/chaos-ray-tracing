...
CRTMatrix::CRTMatrix(const CRTVector& first, const CRTVector& second, const CRTVector& third)
{
	numbers[0] = { first.getComponent(0), first.getComponent(1), first.getComponent(2) };
	numbers[1] = { second.getComponent(0), second.getComponent(1), second.getComponent(2) };
	numbers[2] = { third.getComponent(0), third.getComponent(1), third.getComponent(2) };
