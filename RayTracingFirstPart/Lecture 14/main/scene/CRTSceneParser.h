...
private:
	...
	static CRTMaterial parseRefractiveMaterial(const Value& jsonMaterial);
	...
	static std::vector<CRTexture> parseTextures(const Document& jsonDocument);
	static CRTexture parseTexture(const Value& jsonTexture);
};
